...
const PasswordChange = () => {
  ...
  const handlePasswordChange = (e) => {
    ...
    // axios
    //   .post(
    //     "http://localhost:8000/api/dj-rest-auth/password/change/",
    //     passwordData,
    //     {
    ...
    try {
      ...
      if (error.response && error.response.status === 401) {
        ...
        try {
          ...
          setPasswordErrors(["Failed to refresh token. Please login again."]);
        }
      } else {
        console.log("Error changing password");
        console.log(error);
    ...
    <div className="bg-gray-100 flex justify-center items-center h-screen">
      ...
      <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
        ...
        <form action="#" onSubmit={handlePasswordChange}>
          <div className="mb-4">
            <label htmlFor="new_password1" className="block text-gray-600">
              New Password
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="new_password2" className="block text-gray-600">
