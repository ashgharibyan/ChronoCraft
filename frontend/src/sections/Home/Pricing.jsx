			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="mt-6 text-lg leading-8 text-gray-600">
						Dive into the ChronoCraft journey. With our lifetime Pro
						access, gain evolving tools that elevate your
						productivity, every step of the way.
					</p>
				</div>
                  ...
                  reimbursement.
								...
								<div className="mt-10 items-center">
									{includedFeaturesFree.map((feature) => (
										<li
											key={feature}
											className="flex gap-x-3  mt-2 text-white"
										>
											<CheckIcon
												className="h-6 w-5 flex-none text-indigo-600"
												aria-hidden="true"
					...
					<div className="-mt-2 p-2 lg:mt-0 lg:w-full  lg:max-w-md lg:flex-shrink-0">
						<div className="rounded-2xl bg-gradient-to-tr from-indigo-800 to-gray-800 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
							<div className="mx-auto max-w-xs px-8">
								...
								<a
									href="#"
									className="pointer-events-none mt-10 block w-full rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
								>
									Coming Soon
								</a>
								{/* <p className="mt-6 text-xs leading-5 text-gray-600">
